...
namespace cobalt {
    namespace core {
        ...
        RenderTarget::RenderTarget(const FBO& fbo, const Camera& camera, const std::string& name, const uint cameraUBOBinding)
        ...
        const FBO& RenderTarget::getFBO() const { return fbo; }
