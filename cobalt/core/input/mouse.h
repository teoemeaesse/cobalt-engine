...
namespace cobalt {
    namespace core::input {
        ...
        class Mouse : public Peripheral<MouseInputID> {
            ...
            private:
            float x,
                y;  // Current position. Relative to the top left corner of the
                    // window's content area.
            float dx,
                dy;  // Delta position - difference between the current and last
                     // polled position.
            float dsx,
                dsy;            // Delta scroll - difference between the current and last
                                // polled scroll.
