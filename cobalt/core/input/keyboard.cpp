...
namespace cobalt {
    namespace core {
        ...
        const static UMap<KeyboardInputID, std::string> CB_TO_STR = {
            { KeyboardInputID::A, "Key A" }, { KeyboardInputID::B, "Key B" }, { KeyboardInputID::C, "Key C" }, { KeyboardInputID::D, "Key D" }, { KeyboardInputID::E, "Key E" }, { KeyboardInputID::F, "Key F" }, { KeyboardInputID::G, "Key G" }, { KeyboardInputID::H, "Key H" }, { KeyboardInputID::I, "Key I" }, { KeyboardInputID::J, "Key J" }, { KeyboardInputID::K, "Key K" }, { KeyboardInputID::L, "Key L" }, { KeyboardInputID::M, "Key M" }, { KeyboardInputID::N, "Key N" }, { KeyboardInputID::O, "Key O" }, { KeyboardInputID::P, "Key P" }, { KeyboardInputID::Q, "Key Q" }, { KeyboardInputID::R, "Key R" }, { KeyboardInputID::S, "Key S" }, { KeyboardInputID::T, "Key T" }, { KeyboardInputID::U, "Key U" }, { KeyboardInputID::V, "Key V" }, { KeyboardInputID::W, "Key W" }, { KeyboardInputID::X, "Key X" }, { KeyboardInputID::Y, "Key Y" }, { KeyboardInputID::Z, "Key Z" }, 
            { KeyboardInputID::N0, "Number 0" }, { KeyboardInputID::N1, "Number 1" }, { KeyboardInputID::N2, "Number 2" }, { KeyboardInputID::N3, "Number 3" }, { KeyboardInputID::N4, "Number 4" }, { KeyboardInputID::N5, "Number 5" }, { KeyboardInputID::N6, "Number 6" }, { KeyboardInputID::N7, "Number 7" }, { KeyboardInputID::N8, "Number 8" }, { KeyboardInputID::N9, "Number 9" }, 
            { KeyboardInputID::F1, "Function F1" }, { KeyboardInputID::F2, "Function F2" }, { KeyboardInputID::F3, "Function F3" }, { KeyboardInputID::F4, "Function F4" }, { KeyboardInputID::F5, "Function F5" }, { KeyboardInputID::F6, "Function F6" }, { KeyboardInputID::F7, "Function F7" }, { KeyboardInputID::F8, "Function F8" }, { KeyboardInputID::F9, "Function F9" }, { KeyboardInputID::F10, "Function F10" }, { KeyboardInputID::F11, "Function F11" }, { KeyboardInputID::F12, "Function F12" }, { KeyboardInputID::F13, "Function F13" }, { KeyboardInputID::F14, "Function F14" }, { KeyboardInputID::F15, "Function F15" }, { KeyboardInputID::F16, "Function F16" }, { KeyboardInputID::F17, "Function F17" }, { KeyboardInputID::F18, "Function F18" }, { KeyboardInputID::F19, "Function F19" }, { KeyboardInputID::F20, "Function F20" }, { KeyboardInputID::F21, "Function F21" }, { KeyboardInputID::F22, "Function F22" }, { KeyboardInputID::F23, "Function F23" }, { KeyboardInputID::F24, "Function F24" }, { KeyboardInputID::F25, "Function F25" },
