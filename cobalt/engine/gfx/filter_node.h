...
namespace cobalt {
    namespace engine {
        ...
        class FilterNode : public RenderNode {
             ...
             */
            FilterNode(MaterialPBR& filter, Raster3D& renderer, const CameraID& cameraID, RenderTarget&& defaultTarget);
            /**
            ...
            private:
            MaterialPBR& filter;  // The material to use for the filter quad.
